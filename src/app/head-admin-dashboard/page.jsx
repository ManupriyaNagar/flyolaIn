        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-6">
            <div className="flex items-center">
              <h1 className="text-3xl font-bold text-gray-900">Head Admin Dashboard</h1>
            </div>
            <div className="flex items-center space-x-4">
              <span className="text-sm text-gray-500">Welcome, {authState.user?.name || 'Head Admin'}</span>
              <button
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              <button className="bg-white p-4 rounded-lg shadow hover:shadow-md transition-shadow">
                <div className="text-center">
                  ...
                  <p className="text-xs text-gray-500 mt-1">Access system reports</p>
                </div>
              </button>
              ...
              <button className="bg-white p-4 rounded-lg shadow hover:shadow-md transition-shadow">
                <div className="text-center">
                  ...
                  <p className="text-xs text-gray-500 mt-1">Configure system settings</p>
                </div>
              </button>
              ...
              <button className="bg-white p-4 rounded-lg shadow hover:shadow-md transition-shadow">
                <div className="text-center">
                  ...
                  <p className="text-xs text-gray-500 mt-1">View system alerts</p>
                </div>
              </button>
            </div>
          </div>
