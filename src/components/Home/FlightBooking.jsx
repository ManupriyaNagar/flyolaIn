...
export default function FlightBooking() {
  ...
  return (
    <div
      className="relative flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-gray-900 to-gray-800 p-4"
      style={{
    ...
    >
      ...
      >
        <Card className="bg-white/95 backdrop-blur-md shadow-2xl rounded-3xl border border-gray-200 p-4 md:p-6 lg:p-8 lg:py-20 py-10">
