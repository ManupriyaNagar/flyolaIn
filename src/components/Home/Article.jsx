  ...
  return (
    <section className="py-16 lg:py-24 bg-gradient-to-br from-gray-50 via-white to-indigo-50 relative overflow-hidden">
      ...
      <div className="px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          <div className="inline-flex items-center gap-2 bg-gradient-to-r from-orange-100 to-red-100 text-orange-800 px-6 py-2 text-sm font-bold rounded-full shadow-sm mb-6">
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-gray-900 mb-6 leading-tight">
            Trending &
            <span className="bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent"> Popular Articles</span>
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {articles.map((article, index) => (
            <motion.article
              ...
              className="group bg-white rounded-3xl shadow-lg hover:shadow-2xl overflow-hidden border border-gray-100 transition-all duration-500"
            >
              {/* Image Container */}
              <div className="relative overflow-hidden">
                ...
                <div className="absolute top-4 right-4 bg-white/90 backdrop-blur-sm rounded-full px-3 py-1 flex items-center gap-1">
                  ...
                  <span className="text-xs font-semibold text-gray-800">{article.readTime}</span>
                </div>
              </div>
              ...
              <div className="p-6">
                ...
                <div className="flex items-center justify-between">
                  ...
                  {/* Share Button */}
                  <button className="w-8 h-8 bg-gray-100 rounded-full flex items-center justify-center hover:bg-gray-200 transition-colors duration-300 group-hover:scale-110">
          ...
          <div className="bg-gradient-to-r from-blue-600 to-indigo-600 rounded-3xl p-8 text-white shadow-2xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center max-w-md mx-auto">
              <input
                ...
                className="flex-1 px-4 py-3 border-white border-2 text-white rounded-xl text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-white/50"
              />
              <button className="bg-white text-blue-600 px-6 py-3 rounded-xl font-bold hover:bg-gray-100 transform hover:scale-105 transition-all duration-300 shadow-lg whitespace-nowrap">
                Subscribe Now
              </button>
            </div>
          </div>
