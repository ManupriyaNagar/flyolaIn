      ...
      <div className="px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-gray-900 mb-6 leading-tight">
            Why Choose 
            <span className="bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent"> Flyola</span>
          </h2>
            ...
            <div className="relative h-96 lg:h-[500px] flex items-center justify-center">
              ...
              >
                <motion.img
                  src="/1.png"
                  alt="Private Jet"
                  className="w-48 h-64 lg:w-60 lg:h-80 object-cover rounded-3xl shadow-2xl border-4 border-white"
                ...
                <motion.img
                  src="/2.png"
                  alt="Helicopter"
                  className="w-32 h-32 lg:w-40 lg:h-40 object-cover rounded-2xl shadow-xl border-4 border-white absolute -bottom-4 -right-4 lg:-bottom-6 lg:-right-6"
              ...
              {/* Floating Elements */}
              <div className="absolute top-8 right-8 w-16 h-16 bg-white rounded-full shadow-lg flex items-center justify-center opacity-90">
                <FaCheckCircle className="text-2xl text-green-500" />
              </div>
              
              <div className="absolute bottom-8 left-8 w-20 h-20 bg-white rounded-2xl shadow-lg flex items-center justify-center opacity-90">
            ...
            {features.map((feature, index) => {
              ...
              return (
                <motion.div
                  ...
                  whileHover={{ x: 10 }}
                  className="group flex items-start gap-6 p-6 bg-white rounded-3xl shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100"
                >
                  {/* Icon and Number */}
                  <div className="flex-shrink-0 relative">
                    ...
                    <div className="absolute -top-2 -right-2 w-8 h-8 bg-white rounded-full shadow-md flex items-center justify-center">
                      <span className="text-xs font-bold text-gray-700">{feature.id}</span>
                    </div>
                  </div>
        ...
        >
          <div className="bg-gradient-to-r from-blue-600 to-indigo-600 rounded-3xl p-8 text-white shadow-2xl">
            ...
            <button className="bg-white text-blue-600 px-7 py-3 rounded-2xl font-bold text-lg hover:bg-gray-100 transform hover:scale-105 transition-all duration-300 shadow-lg">
